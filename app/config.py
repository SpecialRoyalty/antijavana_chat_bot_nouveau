...
class Settings(BaseSettings):
    ...
    # Multi-groupes. MAIN_GROUP_ID reste accepté comme bootstrap historique de A.
    main_group_id: Optional[int] = Field(default=None, alias='MAIN_GROUP_ID')
    main_group_a_id: Optional[int] = Field(default=None, alias='MAIN_GROUP_A_ID')
    main_group_b_id: Optional[int] = Field(default=None, alias='MAIN_GROUP_B_ID')

    # VIP communs aux deux groupes principaux.
    ...
    @field_validator(
        'main_group_id', 'main_group_a_id', 'main_group_b_id',
        'pass_soiree_group_id', 'pass_total_group_id', 'vip_javana_group_id', 'log_group_id',
        mode='before',
    )
    @classmethod
    def empty_int(cls, v):
    ...
    @property
    def bootstrap_group_a_id(self) -> Optional[int]:
        return self.main_group_a_id or self.main_group_id
